function clickPage(page) {
    ...
    fetch('http://localhost:8080/posts/'+page +'/'+value,{
        method: 'POST',
        headers : {
...
function addRoom(e){
    for(const room of e) {
        $(".list-room").append(
            ...
            "                                            <a th:href=\"@{posts/"+room.id+"}\">"+room.location.distric+"\n" +
...
function filterRoom() {
    ...
    // var value = document.getElementById("filter").value ;
    // if(value==0) {
    //     fetch('http://localhost:8080/posts/listTimePostDesc',{
    //         method: 'GET',
    //         headers : {
    //             'Content-Type': 'application/json',
    //             'Accept': 'application/json'
    ...
    // }
    // if(value==1){
    //     fetch('http://localhost:8080/posts/listPricesAsc',{
    //         method: 'GET',
    //         headers : {
    //             'Content-Type': 'application/json',
    //             'Accept': 'application/json'
    ...
    // }
    // if(value==2){
    //     fetch('http://localhost:8080/posts/listPricesDesc',{
    //         method: 'GET',
    //         headers : {
    //             'Content-Type': 'application/json',
    //             'Accept': 'application/json'
    ...
    // }
    // if(value==3){
    //     fetch('http://localhost:8080/posts/listStatus',{
    //         method: 'GET',
    //         headers : {
    //             'Content-Type': 'application/json',
    //             'Accept': 'application/json'
